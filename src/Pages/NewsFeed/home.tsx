...
// import StyleProvider from './cssHome';
    ...
    return (
        <>
            <div id='wrapper'>
                    ...
                    <div
                        ...
                        <div className='flex h-20 px-2 max-md:fixed max-md:top-0 max-md:w-full max-md:bg-white/80 max-md:left-0 max-md:px-4 max-md:h-14 max-md:shadow-sm max-md:dark:bg-slate-900/80 backdrop-blur-xl'>
                            <a href='/' id='logo' className='flex items-center gap-3'>
                                ...
                                <img
                                    id='logo__icon'
                                    src="/assets/images/logo-icon.png" alt=""
                        ...
                        {/* <!-- nav --> */}
                        <nav className='flex-1 max-md:flex max-md:justify-around md:space-y-2 *:flex *:gap-2'>
                            {/* <!-- Home --> */}
                            ...
                            <a href='/#!' className='max-md:!fixed max-md:top-2 max-md:right-14 relative'>
                                ...
                                <div className='w-2 h-2 rounded-full absolute left-7 top-2.5'></div>
                            </a>
                            <div
                                className='sm:w-[397px] w-full bg-white shadow-lg md:!left-[73px] hidden !left-0 dark:bg-dark2 dark:border1 max-md:bottom-[57px]'
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <ul className='text-sm font-semibold p-2'>
                                    <li>
                                        <a href='/setting' className='flex gap-3 rounded-md p-2 hover:bg-secondary'>
                                            <IonIcon icon={personOutline} className='text-lg'></IonIcon> Profile
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/upgrade' className='flex gap-3 rounded-md p-2 hover:bg-secondary'>
                                    ...
                                    <li>
                                        <a href='/form-login' className='flex gap-3 rounded-md p-2 hover:bg-secondary'>
                ...
                {/* <!-- main contents --> */}
                <main className='2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small] !ml-[240px]'>
