        ...
        <>
                ...
                <div id="sidebar" className="fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0">
                    ...
                    <div id="sidebar__inner" className="flex sside md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700">
                        ...
                        <nav className="flex-1 max-md:flex max-md:justify-around md:space-y-2">
                            ...
                            {/* <!-- people --> */}
                            <a href="/people" className="max-md:!hidden active">
                                <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <main className="2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small]">
                    ...
                    <div className="max-w-3xl p-6 mx-auto">
                        ...
                        <div className="page__heading">
                            <a href="/#">
                                <IonIcon name="chevron-back-outline"></IonIcon> Back
                            </a>
                            <h1> Peoples</h1>
                        </div>
                        ...
                        <nav className="border-b dark:border-slate-700" uk-sticky="cls-active: bg-slate-100/60 z-30 backdrop-blur-lg px-4 ;  animation: uk-animation-slide-top">
                            ...
                            <ul uk-tab className="flex gap-5 text-sm text-center text-gray-600 capitalize font-semibold -mb-px dark:text-white/80" uk-switcher="connect: #tabs ; animation: uk-animation-slide-right-medium, uk-animation-slide-left-medium">

                                <li> <a href="/#" className="inline-block py-5 border-b-2 border-transparent aria-expanded:text-black aria-expanded:border-black aria-expanded:dark:text-white aria-expanded:dark:border-white"> followers 2,640 </a> </li>
                                <li> <a href="/#" className="inline-block py-5 border-b-2 border-transparent aria-expanded:text-black aria-expanded:border-black aria-expanded:dark:text-white aria-expanded:dark:border-white"> following 1,420 </a> </li>
                                <li> <a href="/#" className="inline-block py-5 border-b-2 border-transparent aria-expanded:text-black aria-expanded:border-black aria-expanded:dark:text-white aria-expanded:dark:border-white"> Suggestions </a> </li>

                            </ul>
                        </nav>

                        <div className="uk-switcher mt-10" id="tabs">
                            ...
                            <div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-2 mt-5 mb-2 text-xs font-normal text-gray-500 dark:text-white/80" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100">
                                    ...
                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-1.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="font-semibold text-sm text-black dark:text-white"> Jesse Steeve</h4>
                                            </a>
                                            <div className="mt-0.5"> 16K following </div>
                                        </div>
                                        <button type="button" className="button bg-secondery rounded-full py-1.5 font-semibold">Fallow</button>
                                    </div>

                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-2.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                    ...
                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-7.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="font-semibold text-sm text-black dark:text-white"> Alexia stella </h4>
                                            </a>
                                            <div className="mt-0.5"> 16K following </div>
                                        </div>
                                        <button type="button" className="button bg-secondery rounded-full py-1.5 font-semibold">Fallow</button>
                                    ...
                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-3.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="font-semibold text-sm text-black dark:text-white"> Monroe Parker </h4>
                                            </a>
                                            <div className="mt-0.5"> 16K following </div>
                                        </div>
                                        <button type="button" className="button bg-secondery rounded-full py-1.5 font-semibold">Fallow</button>
                                    ...
                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-5.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                    ...
                                    <div className="bg-white flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <img src="assets/images/avatars/avatar-6.jpg" alt="" className="rounded-full lg:w-16 lg:h-16 w-10 h-10" />
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                            ...
                            <div>
                                ...
                                <div className="space-y-6 text-sm font-normal text-gray-500" uk-scrollspy="target: > div; cls: uk-animation-slide-bottom-small; delay: 100 ">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-3.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="text-base font-medium text-black dark:text-white"> Monroe Parker </h4>
                                            </a>
                                            <p className="mt-0.5"> 15k following </p>
                                        </div>
                                        <div className="flex gap-3">
                                            <button type="button" className="button bg-primary-soft text-primary border border-primary/10 dark:bg-slate-700 dark:border-slate-600 dark:text-white"> <span className="max-md:hidden">Following</span>  </button>
                                            <button type="button" className="text-white bg-primary button"> <span className="max-md:hidden"> Message </span> </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-2.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="text-base font-medium text-black dark:text-white"> Jesse Steeve </h4>
                                            </a>
                                            <p className="mt-0.5"> 15k following </p>
                                        </div>
                                        <div className="flex gap-3">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-5.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="text-base font-medium text-black dark:text-white"> Alexia stella </h4>
                                            </a>
                                            <p className="mt-0.5"> 15k following </p>
                                        </div>
                                        <div className="flex gap-3">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-6.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="text-base font-medium text-black dark:text-white"> John Michael </h4>
                                            </a>
                                            <p className="mt-0.5"> 15k following </p>
                                        </div>
                                        <div className="flex gap-3">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-7.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <a href="/profile">
                                            <div className="relative w-12 h-12">
                                                <img src="assets/images/avatars/avatar-4.jpg" className="object-cover w-full h-full rounded-full" alt="" />
                                            </div>
                                        </a>
                                        <div className="flex-1">
                                            <a href="/profile">
                                                <h4 className="text-base font-medium text-black dark:text-white"> James Lewis </h4>
                                            </a>
                                            <p className="mt-0.5"> 15k following </p>
                                        </div>
                                        <div className="flex gap-3">
                                ...
                                <div className="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 text-xs font-normal text-gray-500 dark:text-white/80" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100">
                                    ...
                                    <div className="flex flex-col items-center shadow-sm p-2 rounded-xl bg-white border1 dark:bg-dark2">
                                        ...
                                        <div className="mt-5 text-center w-full">
                                            ...
                                            <button type="button" className="block font-semibold mt-4 py-1.5 rounded-lg text-[13px] w-full bg-slate-100/70 dark:bg-slate-700"> Follow </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center shadow-sm p-2 rounded-xl bg-white border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <div className="relative w-20 h-20 mx-auto mt-3">
                                                <img src="assets/images/avatars/avatar-2.jpg" alt="" className="h-full object-cover rounded-full shadow w-full" />
                                            </div>
                                        </a>
                                        <div className="mt-5 text-center w-full">
                                            <a href="/profile">
                                    ...
                                    <div className="flex flex-col items-center shadow-sm p-2 rounded-xl bg-white border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <div className="relative w-20 h-20 mx-auto mt-3">
                                                <img src="assets/images/avatars/avatar-7.jpg" alt="" className="h-full object-cover rounded-full shadow w-full" />
                                            </div>
                                        </a>
                                        <div className="mt-5 text-center w-full">
                                            <a href="/profile">
                                    ...
                                    <div className="flex flex-col items-center shadow-sm p-2 rounded-xl bg-white border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <div className="relative w-20 h-20 mx-auto mt-3">
                                                <img src="assets/images/avatars/avatar-3.jpg" alt="" className="h-full object-cover rounded-full shadow w-full" />
                                            </div>
                                        </a>
                                        <div className="mt-5 text-center w-full">
                                            <a href="/profile">
                                    ...
                                    <div className="flex flex-col items-center shadow-sm p-2 rounded-xl bg-white border1 dark:bg-dark2">
                                        <a href="/profile">
                                            <div className="relative w-20 h-20 mx-auto mt-3">
                                                <img src="assets/images/avatars/avatar-6.jpg" alt="" className="h-full object-cover rounded-full shadow w-full" />
                                            </div>
                                        </a>
                                        <div className="mt-5 text-center w-full">
                                            <a href="/profile">
            ...
            <div className="plan__model w-screen h-screen fixed inset-0 flex justify-center items-center overflow-hidden z-50 bg-white/40 backdrop-blur-sm dark:bg-black/40">
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-xl relative dark:bg-dark2">
                        ...
                        <div className="grid grid-cols-3 gap-5 max-w-2xl mx-auto mt-10">
                            ...
                            <label htmlFor="monthly">
                                ...
                                <div className="relative p-4 bg-slate-100 shadow-sm rounded-xl cursor-pointer peer-checked:[&_.active]:block dark:bg-dark3">
                                    ...
                                    <IonIcon icon={checkmarkCircle} className="hidden active absolute top-0 right-0 m-4 text-2xl text-blue-600 uk-animation-scale-up"></IonIcon>
                                </div>
                            </label>
                        ...
                        <div className="lg:p-8 p-4 shadow-sm mt-6">
                            ...
                            <div className=" text-sm text-gray-500 grid grid-cols-2 gap-10 mt-8 dark:text-white/80">
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={camera} className="flex shrink-0 p-2 text-2xl rounded-full bg-sky-100 text-sky-500 dark:bg-sky-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={image} className="flex shrink-0 p-2 text-2xl rounded-full bg-teal-100 text-teal-500 dark:bg-teal-500/20"></IonIcon>
                                    <div>
                                        <h5 className="text-black text-base font-medium dark:text-white"> Images </h5>
                                        <p className="mt-1 max-md:hidden"> You can upload Unlimited photos and share with your friends </p>
                                    </div>
                                </div>
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={chatbox} className="flex shrink-0 p-2 text-2xl rounded-full bg-orange-100 text-orange-500 dark:bg-orange-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={videocam} className="flex shrink-0 p-2 text-2xl rounded-full bg-pink-100 text-pink-500 dark:bg-pink-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={compass} className="flex shrink-0 p-2 text-2xl rounded-full bg-purple-100 text-purple-500 dark:bg-purple-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={bookmark} className="flex shrink-0 p-2 text-2xl rounded-full bg-green-100 text-green-500 dark:bg-green-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={shield} className="flex shrink-0 p-2 text-2xl rounded-full bg-red-100 text-red-500 dark:bg-red-500/20"></IonIcon>
                                    <div>
                                ...
                                <div className="flex gap-5 max-md:items-center">
                                    <IonIcon icon={cart} className="flex shrink-0 p-2 text-2xl rounded-full bg-sky-100 text-sky-500 dark:bg-sky-500/20"></IonIcon>
                                    <div>
                    ...
                    {/* <!-- close button --> */}
                    <button type="button" className="bg-slate-100 rounded-full p-1 absolute top-0 right-0 m-6 shrink-0 flex dark:bg-dark3" uk-toggle="target: .plan__model ; cls: hidden opacity-0">
                        <IonIcon className="text-2xl" icon={close}></IonIcon>
                    </button>
            ...
            <div className="hidden lg:p-20 max-lg:!items-start" id="create-post" uk-modal="">
                ...
                <div className="uk-modal-dialog tt relative mx-auto bg-white shadow-xl rounded-lg max-lg:w-full dark:bg-dark2">
                    ...
                    {/* <!-- card header --> */}
                    <ul
                        className="uk-switcher posTabs p-3.5 border-b text-center text-sm font-semibold text-black dark:text-white dark:border-slate-700">
                    ...
                    <div className="lg:inline-flex">
                        ...
                        <div className="lg:w-[600px] w-full">
                            ...
                            <div className="w-full lg:h-[600px] h-80 relative overflow-hidden flex justify-center items-center">
                                ...
                                <div className="space-y-4 absolute flex flex-col justify-center"
                                    uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 300;repeat:true">

                                    <div uk-scrollspy-className="uk-animation-scale-up">
                                        <svg className="mx-auto text-gray-600 dark:text-white" width="96" height="77" role="img"
                                    ...
                                    <div className=" mx-auto" uk-scrollspy-className="uk-animation-slide-bottom-small">
                                        <button type="button"
                                            ...
                                            Select from the Computer</button>
                                    </div>

                                </div>

                                <img id="addPostImage" src="#" alt="Uploaded Image"
                                    style={{ display: 'none' }} className="w-full h-full absolute object-cover fff" />
                        ...
                        <div className="relative w-auto border-l dark:border-slate-700">
                            ...
                            <ul className="uk-switcher posTabs">
                                ...
                                <li>
                                    ...
                                    <div
                                        className="lg:w-[300px] lg:max-h-[600px] overflow-y-auto before:uk-animation-slide-right-small">

                                        <div className="p-3.5">

                                            {/* <!-- tabs --> */}
                                            <ul className="flex p-0.5 text-center text-xs font-medium text-gray-700 border rounded-md bg-slate-100 dark:text-white dark:border-slate-700 dark:bg-white/5"
                                                uk-switcher>
                                                <li className="flex-1"> <a href="/#"
                                                    className="block px-4 py-1.5 rounded-md aria-expanded:bg-white aria-expanded:shadow aria-expanded:dark:bg-white/10">Filters</a>
                                                </li>
                                                <li className="flex-1"> <a href="/#"
                                                    className="block px-4 py-1.5 rounded-md aria-expanded:bg-white aria-expanded:shadow aria-expanded:dark:bg-white/10">Adjustments</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div className="uk-switcher">
                                                ...
                                                {/* <!-- filter slider --> */}
                                                <div
                                                    className="space-y-8 py-6 p-1 text-sm font-medium text-gray-700 dark:text-gray-200">

                                                    <div>
                                                        <label htmlFor="range1" className="mb-2 inline-block" > Example range </label>
                                                        <input type="range" min="0" max="6" id="range1"
                                                ...
                                                <div>
                                                    ...
                                                    <div className="grid grid-cols-3 gap-4 mt-3 text-xs text-center font-light"
                                                        ...
                                                        <div className="group cursor-pointer"
                                                            ...
                                                            <div
                                                                className="group-hover:ring-2 ring-blue-600 ring-offset-4 duration-500 rounded dark:ring-offset-slate-800">
                                                                <img src="assets/images/affect.jpg" alt=""
                                ...
                                <li>
                                    ...
                                    <div className="lg:w-[300px] lg:max-h-[600px] overflow-y-auto uk-animation-fade">
                                        ...
                                        <textarea name="" id="" rows={4} placeholder="What is going on.."
                                        ...
                                        <ul className="divide-y divide-gray-100 dark:divide-slate-700" uk-nav="multiple: true">
                                            ...
                                            <li>
                                                ...
                                                <div className="flex items-center justify-between py-2 px-3.5">
                                                    <input type="text" placeholder="Add locations"
                                            ...
                                            <li className="uk-parent uk-open">
                                                <a href="/#" className="flex items-center justify-between py-2 px-3.5 group "
                                                    aria-expanded="true">
                                                ...
                                                <ul className="-space-y-1">
                                                    <li>
                                                        <div className="p-4">
                                                            <p className="text-[13px] font-light"> Alt text helps people with visual
                                                                impairments understand your photos. You can either write your
                                                                own alt text or let it be created automatically for your photos.
                                                            </p>
                                            ...
                                            <li className="uk-parent uk-open">
                                                ...
                                                <ul className="-space-y-2">
                                                    <li>
                                                        <div className="p-4">
                                                            <label
                                                                className="switch flex justify-between items-start gap-4 cursor-pointer min-h-[30px]">
                                                                <div>
                                                                    <h4 className="font-medium text-sm"> Hide like and view counts
                                                                        on this post</h4>
                                                                </div>
                                                                <input type="checkbox" checked /><span
                                                                    className="switch-button !relative shrink-0"></span>
                                                            </label>
                                                            <div>
                                                                <p className="text-[13px] font-light mt-1.5"> Only you will see the
                                                                    total number of likes and views on this post. You can change
                                                                    this later by going to the ··· menu at the top of the post.
                                                                    To hide like counts on other people's posts, go to your
                                                    ...
                                                    <li>
                                                        <div className="p-4">
                                                            ...
                                                            <div>
                                                                <p className="text-[13px] font-light mt-1.5"> You can change this
                                                                    later by going to the menu at the top of your post.</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
