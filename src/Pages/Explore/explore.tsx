        ...
        <>
            <div id="wrapper">
                ...
                <div id="sidebar" className="fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0">
                    ...
                    <div id="sidebar__inner"
                        ...
                        {/* <!-- logo --> */}
                        <div
                            className="flex h-20 px-2 max-md:fixed max-md:top-0 max-md:w-full max-md:bg-white/80 max-md:left-0 max-md:px-4 max-md:h-14 max-md:shadow-sm max-md:dark:bg-slate-900/80 backdrop-blur-xl">
                            <a href="/" id="logo" className="flex items-center gap-3">

                                {/* <!-- logo icon --> */}
                                <img id="logo__icon" src="assets/images/logo-icon.png" alt=""
                                    className="md:w-8 hidden text-2xl max-xl:!block max-md:!hidden shrink-0 uk-animation-scale-up" />

                                {/* <!-- text logo --> */}
                                <img id="logo__text" src="assets/images/logo.svg" alt=""
                                    className="w-full h-6 ml-1 max-xl:hidden max-md:block dark:!hidden" />
                                <img id="logo__text" src="assets/images/logo-dark.svg" alt=""
                        ...
                        <nav className="flex-1 max-md:flex max-md:justify-around md:space-y-2">
                            ...
                            {/* <!-- Home --> */}
                            <a href="/">
                                <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <div className="sm:w-[397px] w-full bg-white shadow-lg md:!left-[73px] hidden !left-0 dark:bg-dark2 dark:border1 max-md:bottom-[57px]"
                                    ...
                                    <div className="p-2 space-y-2 dark:text-white">
                                        ...
                                        <a href="/profile"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="text-xs text-gray-500 font-normal mt-0.5 dark:text-white-80">
                                                    Followed By Johnson </div>
                                            </div>
                                            <button type="button"
                                                className="text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery"> Follow
                                            </button>
                                        </a>
                                        ...
                                        <a href="/profile"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-medium text-sm text-black dark:text-white"> artificial
                                                    intelligence </h4>
                                                <div className="text-xs text-gray-500 font-normal mt-0.5 dark:text-white-80">
                                                    13,352K post </div>
                                            </div>
                                        ...
                                        <a href="/profile"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="text-xs text-gray-500 font-normal mt-0.5 dark:text-white-80"> Parker
                                                    . following </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="/profile"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="text-xs text-gray-500 font-normal mt-0.5 dark:text-white-80"> 9,362K
                                                    post </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="/profile"
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-medium text-sm text-black dark:text-white"> Affiliate marketing
                                                </h4>
                                                <div className="text-xs text-gray-500 font-normal mt-0.5 dark:text-white-80"> 4,248K
                                                    post </div>
                                            </div>
                                        </a>
                            ...
                            {/* <!-- Explore --> */}
                            <a href="/explore" className="max-md:!hidden active">
                                <svg id="icon__outline" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <div className="sm:w-[397px] w-full bg-white shadow-lg md:!left-[73px] hidden !left-0 dark:bg-dark2 dark:border1 max-md:bottom-[57px]"
                                ...
                                <div className="md:h-screen overflow-y-auto h-[calc(100vh-120px)]">
                                    ...
                                    <div className="flex items-center justify-between px-5 py-4 mt-3">
                                        <h3 className="md:text-xl text-lg font-medium mt-3 text-black dark:text-white">Notification
                                        </h3>
                                    ...
                                    <div className="px-2 -mt-2 text-sm font-normal">
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> John Michael</b> who you might know, is on
                                                    Instello.</p>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Alexia Gray</b> started following you. Welcome him
                                                    to your profile. 👋 </p>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1">Jesse Steeve</b> mentioned you in a story. Check
                                                    it out and reply. 📣 </p>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Jesse Steeve</b> sarah tagged you <br /> in a photo
                                                    of your birthday party. 📸 </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                        </a>
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Sarah Gray</b> sent you a message. He wants to
                                                    chat with you. 💖 </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 4 hours ago </div>
                                                <div className="w-2.5 h-2.5 bg-teal-600 rounded-full absolute right-3 top-5"></div>
                                            </div>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> James Lewis</b> Start following you on instello
                                                </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Alexia stella</b> commented on your photo “Wow,
                                                    stunning shot!” 💬 </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                        </a>
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> John Michael</b> mentioned you in a story. Check
                                                    it out and reply. 📣 </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                        </a>
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Jesse Steeve</b> who you might know, is on
                                                    Instello. </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                            <button type="button" className="button text-white bg-primary">fallow</button>
                                        ...
                                        <a href="/#"
                                            ...
                                            <div className="relative w-12 h-12 shrink-0"> <img
                                                ...
                                                className="object-cover w-full h-full rounded-full" /></div>
                                            <div className="flex-1 ">
                                                <p> <b className="font-bold mr-1"> Martin Gray</b> liked your photo of the Eiffel
                                                    Tower. 😍 </p>
                                                <div className="text-xs text-gray-500 mt-1.5 dark:text-white/80"> 8 hours ago </div>
                                            </div>
                                        </a>
                            ...
                            <a href="/!#">
                                <button uk-toggle="target: #create-post" className="flex items-center gap-3 w-full">
                                    ...
                                    <svg id="icon__solid" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="currentColor" className="hidden">
                                        <path fill-rule="evenodd"
                        ...
                        <div>
                            ...
                            <div className="bg-white sm:w-64 2xl:w-[calc(100%-16px)] w-full shadow-lg border rounded-xl overflow-hidden max-md:!top-auto max-md:bottom-16 border2 dark:bg-dark2 hidden"
                                ...
                                <div className="p-4 text-xs font-medium">
                                    ...
                                    <div className="mt-3 flex gap-3.5">
                                        <div> <a href="/profile"> <strong> 620K </strong> <span
                                            className="text-gray-400 dark:text-white/80 ml-1">Following </span> </a> </div>
                                        <div> <a href="/profile"> <strong> 38k </strong> <span
                                            className="text-gray-400 dark:text-white/80 ml-1">Followers </span> </a> </div>
                                    </div>
                                ...
                                <ul className="text-sm font-semibold p-2">
                                    <li>
                                        <a href="/setting" className="flex gap-3 rounded-md p-2 hover:bg-secondery">
                                            <IonIcon name="person-outline" className="text-lg"></IonIcon> Profile
                                        </a>
                                    </li>
                                    <li>
                ...
                <main className="2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small]">
                    ...
                    <div className="main__inner">
                        ...
                        {/* <!-- search box --> */}
                        <div className="z-10 p-5 max-lg:!top-10 lg:rounded-bl-2xl lg:rounded-br-2xl shadow-md bg-slate-100/60 backdrop-blur-3xl dark:bg-slate-800/60"
                            uk-sticky="cls-inactive: invisible h-0; start: 200; animation: uk-animation-slide-top">

                            <div className="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" className="w-5 h-5 absolute left-3 bottom-1/2 translate-y-1/2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                                </svg>
                                <input type="text" placeholder="Search"
                        ...
                        <div className="gallery -mt-16" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100">
                            ...
                            <div className="w-full h-60 bg-slate-200/60 rounded-lg dark:bg-dark2 animate-pulse"></div>
                            <div className="w-full h-60 bg-slate-200/60 rounded-lg dark:bg-dark2 animate-pulse"></div>
                            <div className="w-full h-60 bg-slate-200/60 rounded-lg dark:bg-dark2 animate-pulse"></div>
            ...
            <div className="hidden lg:p-20 max-lg:!items-start" id="preview_modal" uk-modal="">
                ...
                <div
                    ...
                    {/* <!-- right sidebar --> */}
                    <div
                        className="lg:w-[400px] w-full bg-white h-full relative  overflow-y-auto shadow-xl dark:bg-dark2 flex flex-col justify-between">
                        ...
                        <div className="p-5 pb-0">
                                    ...
                                    <div className="w-[253px]"
                                        ...
                                        <nav>
                                            ...
                                            <a href="/#" className="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                                                <IonIcon className="text-xl shrink-0" icon={stopCircleOutline}></IonIcon>
                                                Unfollow
                                            </a>
                                        </nav>
                                    </div>
                            ...
                            <p className="font-normal text-sm leading-6 mt-4"> Photography is the art of capturing light with a
                                ...
                                <div className="flex items-center gap-4 text-xs font-semibold">
                                    <div className="flex items-center gap-2.5">
                                        <button type="button" className="button__ico text-red-500 bg-red-100 dark:bg-slate-700">
                                            <IonIcon className="text-lg" icon={heart} name="heart"></IonIcon>
                                        </button>
                                        <a href="/#">1,300</a>
                                    </div>
                                    ...
                                    <button type="button" className="button__ico">
                                        <IonIcon className="text-xl" icon={bookmarkOutline}></IonIcon>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="bg-white p-3 text-sm font-medium flex items-center gap-2">
                            ...
                            <div className="flex-1 relative overflow-hidden ">
                                <textarea placeholder="Add Comment...." rows={1}
                                    className="w-full resize-  px-4 py-2 focus:!border-transparent focus:!ring-transparent resize-y"></textarea>
                            ...
                            <button type="submit" className="hidden text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery">
                                Replay</button>
